...
float ADC_RATIO[BOARD_NUM] = { 2.9832f/4096.0f, 2.9827f/4096.0f, 2.9845f/4096.0f, 2.9786f/4096.0f };
float ADC_RATIO_DIFF[BOARD_NUM] = { 2.9832f/4096.0f * 2 , 2.9837f/4096.0f * 2 , 2.9845f/4096.0f * 2 , 2.9786f/4096.0f * 2 };
float CURRENT_OUT_OFFSET[BOARD_NUM] = { -8.3960f, -17.1348f , -12.6225f , -16.7374f };
float VOLTAGE_OUT_OFFSET[BOARD_NUM] = { -0.012900f, -0.012900f , 0.037000f , 0.037000f };
float ADC_VOLTAGE_RATIO[BOARD_NUM] = { 22.227f , 22.227f , 20.134f , 20.846f };
float ADC_CURRENT_RATIO[BOARD_NUM] = { 5.100f , 10.3341f , 7.6570f , 10.1010f };
