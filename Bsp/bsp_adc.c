...
float CURRENT_OUT_OFFSET[BOARD_NUM] = { -8.3960f, -17.1348f , -12.6225f , -16.7374f , -15.065f};
float VOLTAGE_OUT_OFFSET[BOARD_NUM] = { -0.012900f, -0.012900f , 0.037000f , 0.037000f , 0.039128f};
float ADC_VOLTAGE_RATIO[BOARD_NUM] = { 22.227f , 22.227f , 20.134f , 20.846f , 21.161f};
float ADC_CURRENT_RATIO[BOARD_NUM] = { 5.100f , 10.3341f , 7.6570f , 10.1010f , 9.3458f};
